<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
    ...
    <div class="m-header">
        ...
        <a href="{{route('dashboard')}}" class="b-brand">
            ...
            <a href=""> <img src="{{ asset('adminAsset') }}/assets/images/logo.png" alt="" class="logo"
                    style="height: 206px;">
            </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-right notification">
                        ...
                        <ul class="noti-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius"
                                        src="{{ asset('adminAsset') }}/assets/images/user/avatar-1.jpg"
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius"
                                        src="{{ asset('adminAsset') }}/assets/images/user/avatar-2.jpg"
                                        alt="Generic placeholder image">
                                    <div class="media-body">
