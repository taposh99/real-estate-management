<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
        ...
        <div class="m-header">
            ...
            <a href="#!" class="b-brand">
                ...
                <img src="{{asset('adminAsset')}}/assets/images/logo.png" alt="" class="logo">
                <img src="{{asset('adminAsset')}}/assets/images/logo-icon.png" alt="" class="logo-thumb">
            </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="{{asset('adminAsset')}}/assets/images/user/avatar-1.jpg" alt="Generic placeholder image">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="{{asset('adminAsset')}}/assets/images/user/avatar-2.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="{{asset('adminAsset')}}/assets/images/user/avatar-1.jpg" class="img-radius" alt="User-Profile-Image">
                                <span>John Doe</span>
                            ...
                            <ul class="pro-body">
                                <li><a href="user-profile.html" class="dropdown-item"><i class="feather icon-user"></i> {{ Auth::user()->name }}</a></li>
                                <li><a href="email_inbox.html" class="dropdown-item"><i class="feather icon-mail"></i> My Messages</a></li>
                                <li><a href="{{ route('login') }}" class="dropdown-item"><i class="feather icon-lock"></i> Lock Screen</a></li>
