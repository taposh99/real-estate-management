                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-border-style">
                            <div class="table-responsive">
                                ...
                                {!! $allCities->withQueryString()->links('pagination::bootstrap-5') !!}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryModalLabel">Add City</h5>
                ...
                <div class="modal-body">
                    ...
                    <form id="categoryForm" action="{{ route('city.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                            <div class="message">
                                @if ($errors->any())
