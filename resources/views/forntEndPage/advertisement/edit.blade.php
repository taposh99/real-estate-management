        ...
        <div class="pcoded-content">
            <div class="container mt-5">
                <div class="text-center">
                    <h4 class="mt-2 mb-2">Advertisement</h4>
                    <!-- message -->
                ...
                <div class="container mt-5">
                    <form action="{{ route('advertisement.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card shadow-sm p-4 mb-5 bg-white rounded">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Update Advertisement Banner</h4>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="mb-3">
                                        <img width="90px" height="50" id="showImage" src="{{ asset('images/advertisement/' . $editBannerValues->image) }}" alt="Banner Image" class="img-thumbnail">
                                    </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-secondary" onclick="window.location='{{ route('advertisement.index') }}'">
